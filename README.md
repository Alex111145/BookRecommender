...
Benvenuto nel progetto **Book Recommender**. Applicazione con un sistema client-server mediante l utilizzo di Ngrok progettato per la gestione e la raccomandazione di libri.
